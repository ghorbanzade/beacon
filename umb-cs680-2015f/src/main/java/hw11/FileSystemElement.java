...
public abstract class FileSystemElement {
  ...
  */
  ...
  /**
  * Each file system element can accept a class that implements
  * FileSystemVisitor. Each file system element type should declare how
  * it would handle the given visitor.
  *
  * @param visitor an object from a subclass of the FileSystemVisitor class
  */
