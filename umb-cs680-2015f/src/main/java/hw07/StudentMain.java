...
public final class StudentMain {
  ...
  */
  public static void main(String[] args) {
    ...
    students.add(StudentFactory.createInStateStudent("Jack"));
    students.add(StudentFactory.createOutStateStudent("John"));
    students.add(StudentFactory.createIntlStudent("Joe"));
