...
public final class StudentMain {
  ...
  */
  public static void main(String[] args) {
    ...
    students.add(new Student("John", StudentStatus.INSTATE));
    students.add(new Student("Joe", StudentStatus.OUTSTATE));
    students.add(new Student("Jack", StudentStatus.INTL));
