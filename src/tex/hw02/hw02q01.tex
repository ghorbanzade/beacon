...
This means that probability of the hypothesis $h_S$ is at least $1 - \epsilon$. This means that the rhombus $h_s$ must intersect at least one of $r_1$, $r_2$, $r_3$ or $r_4$. Therefore,
