...
\item Modify the diagram from (a) such that a customer can have a set of addresses(which are street-city-state triples) and a set of phones. Recall that in the E/R model there can be only primitive data types (no sets).
