...
The algorithm returns the largest independent subset of the subtree rooted at $A[i]$. When called with $i=0$, it returns the maximum size of any independent set in the tree.
